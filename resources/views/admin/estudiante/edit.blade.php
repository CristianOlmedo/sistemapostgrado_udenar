            ...
            <form action="{{ route('estudiante.update', $estudiante->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <select name="cohorte_id" class="form-control" required>
                        ...
                        @foreach ($cohortes as $cohorte)
                            <option value="{{ $cohorte->id }}"
                                {{ $estudiante->cohorte_id == $cohorte->id ? 'selected' : '' }}>
                                {{ $cohorte->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="foto" name="foto"
                        ...
                        value="{{ old('foto', $estudiante->foto) }}">
                    @error('foto')
                ...
                <div class="form-group">
                    ...
                    <select name="genero" id="genero" class="form-control"
                        value="{{ old('genero', $estudiante->genero) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="semestre" class="form-control"
                        value="{{ old('semestre', $estudiante->semestre) }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="fecha_egreso" class="form-control"
                        value="{{ old('fecha_egreso', $estudiante->fecha_egreso) }}" required>
                </div>
