...
@section('body')
    <div class="{{ $auth_type ?? 'login' }}-box">
        ...
        <img src="{{ asset(config('public/images/udenar.png')) }}">
        {{-- Logo --}}
        <!--<div class="{{ $auth_type ?? 'login' }}-logo">
            <a href="{{ $dashboard_url }}">
                ...
                @if (config('adminlte.auth_logo.enabled', false))
                    <img src="{{ asset(config('/images/udenar.png')) }}" alt="{{ config('adminlte.auth_logo.img.alt') }}"
                ...
                @else
                    <img src="{{ asset(config('/images/udenar.png')) }}" alt="{{ config('adminlte.logo_img_alt') }}"
                        height="50">
                @endif
        ...
        style="box-shadow: 5px 5px 5px 5px #ccc">
